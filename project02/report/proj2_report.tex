...
The number of epochs can only be approximate due to all the crashes encountered on Colab but lives around 250 per model. At some point, model begins to overfit and score goes down (for the third model above this point was around 300 epochs).

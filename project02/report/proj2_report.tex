...
Here a list of structures and their corresponding score on AIcrowd. Only the hidden layers are shown, all use ReLU as activation function. All model have an input layer of size 200 and an output layer of size 2 that uses Softmax.
\begin{itemize}
...
We also use Stanford University GloVE's embedding\cite{glovepaper, gloveembedding}. To reduce the computational complexity, we reduce the embedding matrix to the most used word vectors and the tweets to contain only words that are in the embedding matrix.
...
\begin{thebibliography}{9}
	...
	\bibitem{kimyooncode}
		...
		\\\texttt{https://github.com/yoonkim/CNN\_sentence}
	\bibitem{glovepaper}
	...
	\bibitem{gloveembedding}
		...
		\\\texttt{https://nlp.stanford.edu/projects/glove}
	\bibitem{bertpaper}
	...
	\bibitem{bertcode}
		...
		\\\texttt{https://towardsdatascience.com/bert-text-classification-in-3-lines-of-code-using-keras-264db7e7a358}
	\bibitem{sentianal}
